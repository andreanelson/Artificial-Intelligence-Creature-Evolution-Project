...
class URDFLink:
    def __init__(self, name, parent_name, recur, 
                link_length=0.6,  # Increase the length for a more elongated cylinder
                link_radius=0.2,  # Decrease the radius for a thinner, more round cylinder
                link_mass=0.5,    # Adjust mass as needed for physics simulation
                joint_type=0.5,   # Use a revolute joint for rotational movement
                joint_parent=0.5, # Adjust as per your linkage requirements
                joint_axis_xyz=0.5,  # Set to control the axis of rotation (e.g., 0.0 for X-axis, 0.5 for Y-axis, 1.0 for Z-axis)
                joint_origin_rpy_1=1.0,  # Adjust orientation angles as needed
                joint_origin_rpy_2=0.0,
                joint_origin_rpy_3=0.0,
                joint_origin_xyz_1=0.0,  # Adjust position coordinates
                joint_origin_xyz_2=0.0,
                joint_origin_xyz_3=0.5,
